...
||Problem|Solution|
|--|:-----:|:------:|
|**1: Openbox menu**| ~~Working but the menu can't launch $HOME/.local/share/applications/ogui.desktop~~ Not tested yet but the application launcher don't need path anymore, so now it should work. | Copy ~/.local/share/applications/ogui.desktop into an other directory and launch it from there.|
